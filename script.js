...
const policyTemplates = [
    ...
    },
    {
      ...
      'policies': [
        ...
        },
        {
          ...
          Users will be unable to uninstall extensions that are specified by this policy. If you remove an extension from this list, then it will be automatically uninstalled by <ph name="PRODUCT_NAME">$1<ex>Google Chrome</ex></ph>.
    ...
    },
    {
      ...
      'policies': [
        ...
        {
          # TODO(joaodasilva): Flag this policy with 'can_be_recommended'
    ...
    },
    {
      ...
      'desc': '''This policy is active in retail mode only.
      When the value of this policy is set and is not 0 the currently logged in demo user will be logged out automatically after the specified time.
    ...
    },
    {
      ...
      'desc': '''This policy is active in retail mode only.
      Determines the id of the extension to be used as a screen saver on the sign-in screen. The extension must be part of the AppPack that is configured for this domain through the AppPacks policy.''',
    },
    {
    ...
    },
    {
      ...
      'device_only': True,
      'features': {'dynamic_refresh': True},
      'example_value': [ { "extension-id": "khgabmflimjjbclkmljlpmgaleanedem", "update-url": "http://clients2.google.com/service/update2/crx", "online-only": True, } ],
      'id': 135,
      ...
      Each list entry contains a dictionary that must include the extension ID in the 'extension-id' field, and its update URL in the 'update-url' field. The optional 'online-only' field can be set to True to indicate that this extension should be installed only when the device is online at sign-in time.''',
    },
    {
    ...
    },
    {
      ...
      'desc': '''Enables or disables the spell checking web service.
      <ph name="PRODUCT_NAME">$1<ex>Google Chrome</ex></ph> can use a Google web service to help resolve spelling errors. If this setting is enabled, then this service is always used. If this setting is disabled, then this service is never used.
...
// ====== 2. Initialize ======
let policyData = flattenPolicies(policyTemplates);
let currentCategory = '';
